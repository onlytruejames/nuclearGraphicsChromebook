txt = open("../nuclearGraphics/main.py", "r").read()
open("../nuclearGraphics/main.py", "w").write(txt.replace("from cv2 import VideoCapture, cvtColor, COLOR_BGR2RGB", """from cv2 import imread, cvtColor, COLOR_BGR2RGB
class VideoCapture:
    def read():
